...
const curveBottom = document.createElementNS(NAMESPACE, 'path');
...
const curveTop1 = document.createElementNS(NAMESPACE, 'path');
...
const lid = document.createElementNS(NAMESPACE, 'ellipse');
